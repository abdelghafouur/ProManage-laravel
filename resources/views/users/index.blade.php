    ...
    <div class="card">
        ...
        <div class="table-responsive text-nowrap"> 
          ...
          <div class="dt-action-buttons text-end mt-4" style="margin-right: 20px;">
            ...
            <button type="button" onclick="window.location.href='{{ route('users.create') }}'" class="btn btn-outline-primary">
              Ajouter Compte
          </button>
          </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <form id="deleteForm{{ $user->id }}" action="{{ route('users.destroy', $user->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <a href="javascript:void(0);" class="dropdown-item delete-user" data-user-id="{{ $user->id }}">
