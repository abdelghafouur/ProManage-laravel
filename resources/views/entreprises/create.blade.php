...
<div class="container-xxl flex-grow-1">
  ...
  <div class="row">
    <div class="col-xxl">
      <div class="card mb-4">
        <div class="card-body">
          <form method="post" onsubmit="return validateForm()" action="{{ route('entreprises.store') }}"
            enctype="multipart/form-data">
            @csrf
            <div class="card-body">
              <div class="d-flex align-items-start align-items-sm-center gap-4">
                <img src="{{ asset('/assets/img/image/defaultEntreprise.jpg') }}" alt="user-avatar"
                  class="d-block rounded" style="margin-left: 30px" height="100" width="100" id="uploadedAvatar" />
