              ...
              <form method="post" onsubmit="return validateForm()" action="{{ route('entreprises.update', $entreprise->id) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="mb-3 col-lg-6 col-md-6">
                    ...
                    <input type="text" value="{{ $entreprise->email }}" class="form-control" id="basic-default-company2" name="email"  />
                  </div>
                  <div class="mb-3 col-lg-6 col-md-6">
                    <label for="html5-date-input3" class="col-md-2 col-form-label">Adresse</label>
                    <div class="col-md-12">
                      <input class="form-control" value="{{ $entreprise->adresse }}" type="text" name="adresse" id="html5-date-input3"  />
                    </div>
                  </div>
                  <div class="mb-3 col-lg-6 col-md-6">
                  ...
                  <div class="mb-3 col-lg-6 col-md-6">
                    ...
                    <input type="text" value="{{ $entreprise->site }}" class="form-control" id="basic-default-company5" name="site"  />
                  </div>
                  <div class="mb-3 col-lg-6 col-md-6">
                    <label for="html5-date-input6" class="col-md-2 col-form-label">patente</label>
                    <div class="col-md-12">
                      <input class="form-control" value="{{ $entreprise->patente }}" type="text" name="patente" id="html5-date-input6"  />
                    </div>
                  </div>
                  <div class="mb-3 col-lg-6 col-md-6">
                  ...
                  <div class="mb-3 col-lg-6 col-md-6">
                    ...
                    <input type="text" value="{{ $entreprise->if }}" class="form-control" id="basic-default-company8" name="if"  />
                  </div>
                  <div class="mb-3 col-lg-6 col-md-6">
                    <label for="html5-date-input" class="col-md-2 col-form-label9">C.N.S.S</label>
                    <div class="col-md-12">
                      <input class="form-control" value="{{ $entreprise->cnss }}" type="text" name="cnss" id="html5-date-input9"  />
                    </div>
                  </div>
                  <div class="mb-3 col-lg-6 col-md-6">
                  ...
                  <div class="mb-3 col-lg-6 col-md-6">
                    ...
                    <input type="text" value="{{ $entreprise->rib }}" class="form-control" id="basic-default-company11" name="rib"  />
                  </div>
                  <div class="mb-3 col-lg-6 col-md-6">
                    <label for="html5-date-input13" class="col-md-2 col-form-label">swift</label>
                    <div class="col-md-12">
                      <input class="form-control" value="{{ $entreprise->swift }}" type="text" name="swift" id="html5-date-input13"  />
                    </div>
                  </div>
                  <div class="mb-3 col-lg-6 col-md-6">
                    <label class="form-label" for="basic-default-company12">iban</label>
                    <input type="text" value="{{ $entreprise->iban }}" class="form-control" id="basic-default-company12" name="iban"  />
                  </div>
                  <div class="mb-3 col-lg-6 col-md-6">
                    <label for="html5-date-input14" class="col-md-2 col-form-label">validite</label>
                    <div class="col-md-12">
                      <input class="form-control" value="{{ $entreprise->validite }}" type="text" name="validite" id="html5-date-input14"  />
                    </div>
                  </div>
