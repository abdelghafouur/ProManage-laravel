    ...
    <div class="table-responsive text-nowrap">
        <div class="dt-action-buttons text-end mt-4 mb-3" style="margin-right: 20px;">
            <div class="row">
                ...
                <label class="col-sm-2 mx-3">
                    Date Fin : <input type="date" style="display: inline;width: 70%;" id="dateFin"
                        placeholder="Search by Date" class="form-control" />
                </label>
        ...
        <table class="table table-striped">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    <td><a href="{{ route('factures.show', $paiment->facture_id ) }}">{{ $paiment->facture->client->nom
                            }}</a></td>
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('factures.show', $paiment->facture_id ) }}"><i
