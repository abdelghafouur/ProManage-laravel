                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('clients.show', $client->id) }}"><i class='bx bx-show-alt me-1'></i> Show</a>
...
<script>
    $(document).on('click', '.delete-client', function(event) {
        ...
        var clientId = triggerElement.data('client-id');
        var deleteForm = $('#deleteForm' + clientId);

        // Set the client ID for the "Delete" button in the modal
        $('#deleteButton').data('client-id', clientId);
