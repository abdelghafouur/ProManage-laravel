...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="light-style layout-menu-fixed layout-wide"
    ...
    <body>
        ...
        <div class="layout-wrapper layout-content-navbar">
                ...
                <!-- Menu -->
                    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                        <div class="app-brand demo">
                            ...
                            <img src="{{ asset('assets/img/image/logo-imayweb.svg') }}" height="110" width="195" class="me-2 rounded-circle" alt="logoImayweb"/>
                            </span>                               
                        ...
                        <li class="menu-item {{ request()->is('paiments*') ? 'active' : '' }}">
                            ...
                            <div data-i18n="Calendar">Gestion Paiments</div>
                            </a>
                        </li>
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            ...
                            <div class="avatar avatar-online">
                                            <img src="{{ asset('storage/' . Auth::user()->profile_photo_path) }}"  alt="Admin Image" class="w-px-40 h-auto rounded-circle">
                            ...
                            <li>
                                ...
                                <span class="align-middle">Gestion Comptes</span>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('entreprises.index') }}">
                                <i class='bx bx-building-house me-2'></i>
                                <span class="align-middle">Gestion Entreprises</span>
                                </a>
                            </li>
                            @endunless
                            <li>
            ...
            <!--  alert -->
            <div id="myAlert" class="bs-toast toast toast-placement-ex m-2 fade bg-success top-0 start-50 translate-middle-x @if(session('success')) show @endif" role="alert" aria-live="assertive" aria-atomic="true">
            ...
            <!--  alert -->
            <div id="myAlert" class="bs-toast toast toast-placement-ex m-2 fade bg-danger top-0 start-50 translate-middle-x @if(session('error')) show @endif" role="alert" aria-live="assertive" aria-atomic="true">
                <div class="toast-header">
                    <i class='bx bxs-badge-check'></i>
