                        ...
                        <div class="col-md-4 col-xl-4">
                            ...
                            <div class="card-body">
                                ...
                                <dl class="row mt-2">
                                    ...
                                    <dd class="col-sm-8">{{ number_format($totalTTC - $totalMontant, 2, ',', '') }}</dd>
                                </dl>
                            </div>
                            </div>
                        </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item edit-detailpaiment" href="#" data-bs-toggle="modal" data-bs-target="#modalCenter2" 
                                                        ...
                                                        <form id="deleteForm{{ $paiment->id }}" action="{{ route('paiments.destroy', $paiment->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="javascript:void(0);" class="dropdown-item delete-paiment" data-paiment-id="{{ $paiment->id }}">
                    ...
                    <div class="col-sm-11 mt-3 mb-3">
                        <div class="btn-group dropup">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                              <li><a class="dropdown-item" type="button" href="{{ route('Fac.download', ['FactureId' => $facture->id]) }}"  target="_blank">Download Facture</a></li>
                              <li><a class="dropdown-item" type="button" href="{{ route('Fac.generate', ['FactureId' => $facture->id]) }}"  target="_blank">Generate Facture</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div class="col-lg-4 col-md-6">
    <div class="mt-3">
        <form id="editDetailPaimentForm" method="post" action="{{ route('paiments.update', ['paiment' => $facture->id]) }}">
            @csrf
            @method('PUT')
