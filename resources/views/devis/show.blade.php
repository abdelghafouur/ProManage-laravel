...
<div class="container-xxl flex-grow-1">
  <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="{{ route('devis.index') }}" style="color:#a1acb8 !important">Gestion Devis/</a></span> Show Devis</h4>
    <div class="row">
        <div class="col-lg">
            <div class="card">
                  ...
                  <div class="col-sm-11 mt-3 mb-3">
                      <div class="btn-group dropup">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                          <li><a class="dropdown-item" type="button" href="{{ route('Dev.download', ['DevisId' => $devis->id]) }}"  target="_blank">Download Devis</a></li>
                          <li><a class="dropdown-item" type="button" href="{{ route('Dev.generate', ['DevisId' => $devis->id]) }}"  target="_blank">Generate Devis</a></li>
                        </ul>
                    </div>
                      <button type="button" class="btn btn-primary text-end" onclick="window.location.href='{{ route('factures.create', ['devis_id' => $devis->id]) }}'">Create Facture</button>
                  </div>
              </div>
            </div>
        </div>
