...
<div class="card">
    <div class="table-responsive text-nowrap">
        <div class="dt-action-buttons text-end mt-4 mb-3" style="margin-right: 20px;">
            ...
            <button type="button" onclick="window.location.href='{{ route('devis.create') }}'" class="btn btn-outline-primary">
                Ajouter devis
            </button>
        </div>
        <table class="table">
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('devis.edit', $devis->id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
